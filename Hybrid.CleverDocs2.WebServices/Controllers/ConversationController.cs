...
namespace Hybrid.CleverDocs2.WebServices.Controllers
{
    ...
    public class ConversationController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ConversationRequest request) => Ok(await _client.CreateAsync(request));
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, ConversationRequest request) => Ok(await _client.UpdateAsync(id, request));
