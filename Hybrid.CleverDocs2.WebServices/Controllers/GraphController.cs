...
namespace Hybrid.CleverDocs2.WebServices.Controllers
{
    ...
    public class GraphController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(GraphRequest request) => Ok(await _client.CreateAsync(request));
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, GraphRequest request) => Ok(await _client.UpdateAsync(id, request));
