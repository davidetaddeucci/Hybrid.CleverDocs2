...
namespace Hybrid.CleverDocs2.WebServices.Controllers
{
    ...
    public class MaintenanceController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(MaintenanceRequest request) => Ok(await _client.CreateAsync(request));
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, MaintenanceRequest request) => Ok(await _client.UpdateAsync(id, request));
