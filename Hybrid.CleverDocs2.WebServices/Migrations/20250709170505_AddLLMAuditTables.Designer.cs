...
namespace Hybrid.CleverDocs2.WebServices.Migrations
{
    ...
    [Migration("20250709170505_AddLLMAuditTables")]
    partial class AddLLMAuditTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hybrid.CleverDocs2.WebServices.Data.Entities.UserLLMPreferences", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserLLMPreferences", t =>
                        {
                            t.HasCheckConstraint("CK_UserLLMPreferences_MaxTokens", "\"MaxTokens\" >= 1 AND \"MaxTokens\" <= 32000");

                            t.HasCheckConstraint("CK_UserLLMPreferences_Provider", "\"Provider\" IN ('openai', 'anthropic', 'azure', 'custom')");

                            t.HasCheckConstraint("CK_UserLLMPreferences_Temperature", "\"Temperature\" >= 0.0 AND \"Temperature\" <= 2.0");

                            t.HasCheckConstraint("CK_UserLLMPreferences_TopP", "\"TopP\" IS NULL OR (\"TopP\" >= 0.0 AND \"TopP\" <= 1.0)");
                        });
                });
